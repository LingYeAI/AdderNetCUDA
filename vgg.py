...
__all__ = [
    ...
    'vgg11_nd_ss', 'vgg13_nd_ss', 'vgg16_nd_ss', 'vgg19_small_add',
]

def conv3x3(in_planes, out_planes, stride=1):
    " 3x3 convolution with padding "
    return adder.adder2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False, depth_wise=False)
...
def vgg19_small_add(num_classes=10, quantize=False, weight_bits=8, sparsity=0, **kwargs):
    """VGG 19-layer model (configuration "E")"""
