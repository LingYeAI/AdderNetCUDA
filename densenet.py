...
class Bottleneck(nn.Module):
    def __init__(self, in_planes, growth_rate):
        ...
        self.conv1 = adder.adder2d(in_planes, 4 * growth_rate, kernel_size=1, bias=False)
        self.bn2 = nn.BatchNorm2d(4 * growth_rate)
        self.conv2 = adder.adder2d(4 * growth_rate, growth_rate, kernel_size=3, padding=1, bias=False)
...
class Transition(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.conv = adder.adder2d(in_planes, out_planes, kernel_size=1, bias=False)
